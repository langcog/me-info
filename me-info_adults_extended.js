...
var experiment = {
	...
	train: function(counter, words, imgs, type) {
		...
		var len1 = (spriteData["one_" + wordList[0]].end-spriteData["one_" + wordList[0]].start)*1000
		var len2 = (spriteData["look_" + wordList[0]].end-spriteData["look_" + wordList[0]].start)*1000
		var len3 = (spriteData["this_" + wordList[0]].end-spriteData["this_" + wordList[0]].start)*1000

		//play word 1
		playPrompt("one_" + wordList[0]);
		setTimeout(function(){playPrompt("look_" + wordList[0]);
			setTimeout(function(){playPrompt("this_" + wordList[0])},len2+250)},len1+250);
		//;
			...
			$("#checkButton").off('click').on('click', function() {
				...
				if (check1.length == 0) {
					...
					setTimeout(function() {
						...
						var len1 = (spriteData["one_" + wordList[1]].end-spriteData["one_" + wordList[1]].start)*1000
						var len2 = (spriteData["look_" + wordList[1]].end-spriteData["look_" + wordList[1]].start)*1000
						var len3 = (spriteData["this_" + wordList[1]].end-spriteData["this_" + wordList[1]].start)*1000

						//play word 2
						playPrompt("one_" + wordList[1]);
						setTimeout(function(){playPrompt("look_" + wordList[1]);
							setTimeout(function(){playPrompt("this_" + wordList[1])},len2+250)},len1+250);
